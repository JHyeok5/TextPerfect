            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="p-3 bg-gray-50 border rounded-md">
                  {currentUser.nickname || currentUser.name || currentUser.email?.split('@')[0] || '설정되지 않음'}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="p-3 bg-gray-50 border rounded-md">
                  {currentUser.createdAt ? new Date(currentUser.createdAt).toLocaleDateString('ko-KR', {
                    ...
                    month: 'long',
                    day: 'numeric'
                  }) : currentUser.created_at ? new Date(currentUser.created_at).toLocaleDateString('ko-KR', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                  }) : '정보 없음'}
          ...
          <div className="p-6 text-center">
            ...
            <div className="mb-6">
              ...
              <div className="text-gray-600">
                {currentUser.nickname || currentUser.name || currentUser.email?.split('@')[0] || '사용자'}
              </div>
            </div>
            
            <div className="mb-6">
              <div className="text-sm text-gray-600 mb-2">경험치</div>
              <ProgressBar value={currentUser.exp || currentUser.experience || 0} max={1000} />
              <div className="text-xs text-gray-500 mt-1">
                {currentUser.exp || currentUser.experience || 0} / 1000 XP
              </div>
            </div>
            
            <div className="text-sm text-gray-600">
              <div>다음 레벨까지 {1000 - (currentUser.exp || currentUser.experience || 0)}XP</div>
            </div>
          </div>
        </Card>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="text-3xl font-bold text-blue-600 mb-2">
                  {currentUser.stats?.optimizedDocs || currentUser.optimized_docs || 0}
                </div>
              ...
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-3xl font-bold text-green-600 mb-2">
                  {currentUser.stats?.improvedSentences || currentUser.improved_sentences || 0}
                </div>
              ...
              <div className="text-center p-4 bg-yellow-50 rounded-lg">
                <div className="text-3xl font-bold text-yellow-600 mb-2">
                  {currentUser.stats?.avgImprovement || currentUser.avg_improvement || 0}%
                </div>
              ...
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                <div className="text-3xl font-bold text-purple-600 mb-2">
                  {currentUser.stats?.consecutiveDays || currentUser.consecutive_days || 0}
                </div>
